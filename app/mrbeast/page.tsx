        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex gap-6">
              ...
              <Link
                href="/mrbeast/edit"
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-green-500 text-white rounded-lg hover:shadow-lg hover:shadow-green-500/50 transition-all"
              >
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-slate-800/30 rounded-lg border border-slate-700">
              <p className="text-gray-400 text-lg">
                {filter
                  ...
                  : "No video data yet. Add videos to get started."}
              </p>
              {!filter && (
                <Link
                  href="/mrbeast/edit"
                  className="mt-4 inline-block px-6 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg transition-colors"
                >
                  Add First Video
                </Link>
              )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredStats.map((stat) => {
                const confidenceInterp = getConfidenceInterpretation(
                  stat.confidence
                );
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span
                          className={`text-lg font-bold ${getProbabilityBgColor(
                            stat.probability
                          ...
                          <div className="space-y-1 text-xs">
                            <div className="flex justify-between">
                              ...
                              <span className="text-green-400">
                                {stat.metrics.effectiveSampleSize.toFixed(1)}{" "}
                                videos
                              </span>
                            </div>
                            <div className="flex justify-between">
